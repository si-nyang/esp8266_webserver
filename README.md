...
- Base Time: **0200 또는 2300** (TMN/TMX 정확도 최대)
  - 00~02시: 전날 2300
  - 02~23시: 당일 0200
  - 23~24시: 당일 2300
- 용도: hourly(시간별 예보) + daily(3일까지 기온)
...
- daily: 12시간 (단기+중기 통합)
- now: 1시간 (hourly/daily 캐시에서 재계산, API 호출 없음)

**프리패치 스케줄 (5회/일)**
- **02:10**: 단기예보 0200 (hourly + daily-3d 기온)
- **06:10**: 중기예보 0600 (daily-4d~)
...
![Web Dashboard](sad_img/web_dashboard.png)

- Replit Flask 서버 기반 웹 인터페이스
- 실시간 센서 데이터 + 기상청 예보 통합
- AI 기반 날씨 요약 (OpenAI GPT-4)
- 시간별/일별 예보 차트
- 반응형 디자인 (모바일/데스크톱 지원)

---

## 부록2. 핀맵 (Wemos D1 mini 기반 전체 배선표)
